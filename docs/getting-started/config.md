...
Sem ele, a API pública limita uploads a **50 MB**. Com servidor self-hosted, vai até **2 GB** (limite hard do Telegram pra bots — Premium não afeta bots, [issue #583](https://github.com/tdlib/telegram-bot-api/issues/583)).
