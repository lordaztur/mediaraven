...
from handlers import future_callback, handle_message, retry_callback
...
if __name__ == '__main__':
    ...
    application.add_handler(CallbackQueryHandler(future_callback, pattern=r"^(dl|lang|cap|scrn)\|"))
